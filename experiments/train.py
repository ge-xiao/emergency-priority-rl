...
class Trainer():
    ...
    def run(self):
        for i in range(self.epochs):
            ...
            #
            # if i>0 and i%10==0:
            #     ob = self.env.reset(mode="test",epoch=i)
            #     self.model.resetLstm()
            #     self.mode = "test"
            #     rewards = []
            #
...
if __name__ == '__main__':
    ...
    #config.read('../config/test_5x5/ia2c.ini')
    #config.read('../config/test_5x5_2/ia2c.ini')
    #config.read('../config/hangzhou/ia2c.ini')
    #config.read('../config/manhattan/ia2c.ini')

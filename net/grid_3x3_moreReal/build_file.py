...
def output_flows(peak_flow1, peak_flow2, density, seed=None):
    ...
    str_flows += '  <vType id="emergency" length="5" accel="5" maxSpeed="20" minGap="2.5"  vClass="emergency" guiShape="emergency"/>\n'
    ...
    str_flows += '  <flow id="emergency1" departPos="base" departLane="best" from="%s" to="%s" begin="0" end="3000" vehsPerHour="%s" type="emergency"/>\n' % (edgeNameByIdx('w', 3, True), edgeNameByIdx('e', 1, False), ev_flow)
    str_flows += '  <flow id="emergency2" departPos="base" departLane="best" from="%s" to="%s" begin="0" end="3000" vehsPerHour="%s" type="emergency"/>\n' % (edgeNameByIdx('s', 2, True), edgeNameByIdx('n', 2, False), ev_flow)
    ...
    srcs.append(edgeNameByIdx('w', 1, True))
    sinks.append(edgeNameByIdx('e', 2, False))

    srcs.append(edgeNameByIdx('w', 2, True))
    sinks.append(edgeNameByIdx('e', 3, False))

    srcs.append(edgeNameByIdx('w', 3, True))
    sinks.append(edgeNameByIdx('e', 1, False))

    srcs.append(edgeNameByIdx('s', 1, True))
    sinks.append(edgeNameByIdx('n', 2, False))

    srcs.append(edgeNameByIdx('s', 2, True))
    sinks.append(edgeNameByIdx('n', 3, False))

    srcs.append(edgeNameByIdx('s', 3, True))
    sinks.append(edgeNameByIdx('n', 1, False))


    srcs.append(edgeNameByIdx('e', 1, True))
    sinks.append(edgeNameByIdx('w', 2, False))

    srcs.append(edgeNameByIdx('e', 2, True))
    sinks.append(edgeNameByIdx('w', 3, False))

    srcs.append(edgeNameByIdx('e', 3, True))
    sinks.append(edgeNameByIdx('w', 1, False))


    srcs.append(edgeNameByIdx('n', 1, True))
    sinks.append(edgeNameByIdx('s', 2, False))

    srcs.append(edgeNameByIdx('n', 2, True))
    sinks.append(edgeNameByIdx('s', 3, False))

    srcs.append(edgeNameByIdx('n', 3, True))
    sinks.append(edgeNameByIdx('s', 1, False))
    ...
    ratios = np.array([0.4, 0.6, 0.8, 0.9, 1.0, 0.9, 0.8, 0.6, 0.4, 0.2])  # start from 0

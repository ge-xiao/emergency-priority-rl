...
def output_flows(peak_flow1, peak_flow2, density, seed=None):
    ...
    str_flows += '  <flow id="emergency1" departPos="base" departLane="best" from="%s" to="%s" begin="0" end="3000" vehsPerHour="%s" type="emergency1"/>\n' % (edgeNameByIdx('w', 5, True), edgeNameByIdx('e', 1, False), ev_flow)
    str_flows += '  <flow id="emergency2" departPos="base" departLane="best" from="%s" to="%s" begin="0" end="3000" vehsPerHour="%s" type="emergency2"/>\n' % (edgeNameByIdx('s', 3, True), edgeNameByIdx('n', 3, False), ev_flow)
    str_flows += '  <flow id="emergency3" departPos="base" departLane="best" from="%s" to="%s" begin="0" end="3000" vehsPerHour="%s" type="emergency3"/>\n' % (edgeNameByIdx('e', 3, True), edgeNameByIdx('w', 1, False), ev_flow)
